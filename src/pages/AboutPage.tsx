        ...
        <div className="container px-4 sm:px-6 py-12">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-12">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-brand-navy mb-6">
                About WebLiveView
              </h1>
            </div>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-brand-navy mb-4">From Showroom to Screen</h2>
              ...
              <section className="mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-brand-navy mb-4">Bringing Back the Human Touch</h2>
                <p className="text-lg text-foreground mb-4">
                  Our mission is simple: make online shopping feel as personal as walking into a store. With WebLiveView, sales teams can:
                </p>
                <ul className="text-lg text-foreground mb-4 space-y-2">
              ...
              {/* What Drives Us */}
              <section className="mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-brand-navy mb-4">What Drives Us</h2>
                <ul className="text-lg text-foreground space-y-3">
              ...
              <section className="mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-brand-navy mb-4">Why Choose WebLiveView</h2>
                <ul className="text-lg text-foreground space-y-3">
              ...
              <section className="mb-12 text-center">
                <h2 className="text-2xl sm:text-3xl font-bold text-brand-navy mb-4">What's Next</h2>
                <p className="text-lg text-foreground mb-4">
                ...
                <p className="text-xl font-semibold text-brand-navy mb-6">
