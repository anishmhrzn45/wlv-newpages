        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-20 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-6 lg:space-y-8 w-full">
            <div className="text-center lg:text-left max-w-full">
              <h1 className="text-primary text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-extrabold leading-tight break-words">
                Increase your sales using our video shopping software
              </h1>
              <p className="text-muted-foreground text-base sm:text-lg lg:text-xl mt-3 lg:mt-4 break-words">
                Try it today at <span className="text-secondary font-medium">no cost for the first 14 days</span>.
              </p>
            </div>

            {/* Why Sign Up Section */}
            <div className="space-y-4 pt-2 lg:pt-4 w-full">
              ...
              <div className="space-y-3 w-full">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3 text-left w-full">
                    <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center mt-0.5">
                      <Check className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" />
                    </div>
                    <span className="text-foreground text-sm sm:text-base break-words flex-1">{benefit}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="block pt-6 lg:pt-8 space-y-4 w-full">
